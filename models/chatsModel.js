...
// chat must contain only 2 users to this works correctly
...
/// TODO if users will be more than 2, how filter will work?
export const getAllChatsByUserId = async (userId) => {
    ...
    /// TODO do it in query
    result.rows.forEach(row => row.id = row.chat_id);
